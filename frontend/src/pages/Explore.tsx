...
export default function Explore() {
    ...
    return <main id="main" className="explore-page" aria-busy={loading}>
        ...
        {loading && !data ?
            <div className="masonry-grid explore-grid explore-loading" role="status" aria-label="正在加载作品">
                {Array.from({length: 4}, (_, index) => <div className="explore-card" key={index} aria-hidden="true">
                    <div className="explore-image skeleton-block"/>
                    <div className="explore-copy">
                        <span className="skeleton-block skeleton-title"/>
                        <div className="explore-caption">
                            <span className="avatar explore-avatar skeleton-block"/>
            ...
            : error ? <div className="sharing-state" role="alert"><p>{error}</p>
                ...
                : !data?.records.length ?
                    ...
                    : <MasonryGrid className="explore-grid">{data.records.map((work, index) => <Link
