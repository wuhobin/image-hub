...
export default function AdminUsers() {
  ...
  return <div className="admin-users-page">
    <div className="admin-page-title"><div><span className="admin-eyebrow">账户与使用情况</span><h1>用户管理</h1><p>查找平台用户，查看他们的剩余上传额度。</p></div></div>
    <section className="admin-directory" aria-labelledby="admin-users-title">
      ...
      <div className="admin-table-scroll" aria-busy={loading} tabIndex={0} aria-label="用户列表">
        <table className="admin-table"><thead><tr><th scope="col">用户</th><th scope="col">邮箱</th><th scope="col">注册时间</th><th scope="col" className="admin-number">剩余额度</th></tr></thead>
    ...
    <p className="admin-directory-note">剩余额度以本次查询为准。显示「—」表示暂无额度记录。</p>
  </div>
}
